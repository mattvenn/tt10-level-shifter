...
C {devices/vdd.sym} 10 -140 0 0 {name=l7 lab=VDD
}
...
C {devices/gnd.sym} -80 160 0 0 {name=l9 lab=GND}
C {devices/gnd.sym} 100 160 0 0 {name=l13 lab=GND}
...
C {devices/vdd.sym} 360 -40 0 0 {name=l14 lab=VDD}
C {devices/gnd.sym} 360 160 0 0 {name=l15 lab=GND}
...
C {devices/vdd.sym} -330 -140 0 0 {name=l3 lab=VDD
}
...
C {devices/gnd.sym} -330 160 0 0 {name=l4 lab=GND}
...
C {devices/gnd.sym} -510 160 0 0 {name=l5 lab=GND}
C {devices/vdd.sym} -510 -50 0 0 {name=l6 lab=VDD_L
}
...
C {devices/iopin.sym} -520 -350 2 0 {name=p4 lab=GND sim_pinnumber=1}
